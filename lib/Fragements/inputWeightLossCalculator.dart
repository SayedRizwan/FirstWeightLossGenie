...
import 'package:bmi_calculator/calclulator_wl.dart';
...
class _InputPageMBIState extends State<InputPageWL> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
              ...
              Container(
                  padding: const EdgeInsets.all(8.0), child:  Text('WEIGHT LOSS CALCULATOR',
        style: TextStyle(
          fontSize: 15,
  ...
  Expanded(
          ...
          BottomButton(
            ...
            onTap: (){
           CalculatorBrainWL calc= CalculatorBrainWL(gender: gender, waist: waist, weight: weight, wrist: wrist, forearm: forearm, hips: hips);
