...
class ResultPageWL extends StatelessWidget {
  ...
  ResultPageWL({required this.bfpResult, required this.resultText, required this.interpretation});
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
              ...
              Container(
                  padding: const EdgeInsets.all(8.0), child: Text('WEIGHT LOSS RESULT',
        style: TextStyle(
          fontSize: 15,
